words = ['electricity', 'donkey', 'hardware', 'xerox', 'transistor', 'computer', 'desktop',
 ...
 'agreement', 'sorrow', 'christmas', 'silver', 'birthday', 'championship', 'friendly',
 ...
 'absence', 'mystery', 'morning', 'device', 'thoughts', 'spirit', 'future', 'impo1ite',
 ...
 'finger', 'belief', 'crystal', 'fashion', 'direction', 'captain', 'moment', 'impish',
 'permission', 'logic', 'analysis', 'password', 'english', 'simulation',
 ...
 'failure', 'ignorance', 'destination', 'source', 'resort', 'satisfaction', 'examine',
 ...
 'surprise', 'nothing', 'ladder', 'opposite', 'reality', 'genius', 'string', 'distinguish',
 ...
 'abrupt', 'absolute', 'absorption', 'abstract', 'academy', 'acceleration', 'accented',
 ...
 'arithmetic', 'arrangement', 'article', 'ascending', 'ashamed', 'asleep', 'assassin',
 'assembly', 'astonishment', 'atmosphere', 'awful', 'bachelor', 'backbone', 'backward',
 ...
 'circumference', 'classroom', 'clearance', 'client', 'coconut', 
 'coincidence', 'colleague', 'comfortable', 'competition', 'kangaroo', 'kidnap', 
 'journal', 'jockey', 'iteration', 'isometric', 'isolation', 'invitation', 'interest',
 'institution', 'injection', 'humanity', 'housekeeper', 'history', 'heaven', 
 'greenhouse', 'glory', 'foundation', 'formula', 'fluctuation', 'fiction', 
 'emission', 'elasticity', 'earthquake', 'dynamic', 'doctorate', 'divorce', 'deri', 'nightmare', 'virtue']